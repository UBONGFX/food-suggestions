          ...
          <section className="grid gap-6">
              ...
              <div className="flex flex-col items-center text-center gap-4 sm:gap-6 sm:grid sm:grid-cols-[6.5rem,1fr] sm:items-start sm:text-left">
                ...
                <div className="grid gap-4 w-full max-w-sm sm:max-w-none sm:min-w-0">
                  <div className="grid gap-1.5">
                    ...
                    <input type="text" placeholder="Dein Name" className="w-full px-3 py-2 rounded-md border bg-white dark:bg-zinc-800 border-black/10 dark:border-white/10" />
                  </div>
                  <div className="grid gap-1.5">
                    <label className="text-sm font-medium">E‑Mail</label>
                    <input type="email" placeholder="du@example.com" className="w-full px-3 py-2 rounded-md border bg-white dark:bg-zinc-800 border-black/10 dark:border-white/10" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-black/10 dark:border-white/10 bg-white/70 dark:bg-zinc-900/70 p-6">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <button className="px-4 py-2 rounded-md border border-black/10 dark:border-white/10 hover:bg-black/5 dark:hover:bg-white/10">Passwort zurücksetzen</button>
                <button className="px-4 py-2 rounded-md border border-black/10 dark:border-white/10 hover:bg-black/5 dark:hover:bg-white/10">Abmelden</button>
              </div>
            </div>
          </section>
        )}
